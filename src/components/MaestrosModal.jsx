...
export default function MaestrosModal({ franchises, franchisor, comps, onSaveFr, onAddFr, onDeleteFr, onSaveFranchisor, onClose }) {
  const [topSection,  setTopSection]  = useState(null);  // arranca en el landing (antes abría en TC, que ya no vive acá)
      ...
      <div style={{ background:"var(--bg2)", border:"1px solid var(--border2)", borderRadius:14,
        ...
        <div style={{ display:"flex", minHeight:520 }}>
          ...
          <div style={{ width:210, borderRight:"1px solid var(--border)",
            ...
            {/* El maestro de Tipo de Cambio se mudó a Numbers (Maestros › Tipos de Cambio):
                es un dato de todo el grupo, no solo de franquicias. Acá el TC solo se LEE. */}
          </div>
