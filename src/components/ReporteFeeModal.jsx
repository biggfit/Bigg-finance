...
function buildEmailHtml({ rows, month, year, prev, tcActual, tcPrevRef }) {
  ...
  return '<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">' +
    ...
    '<div style="font-size:11px;color:#888;margin-bottom:6px;">Ante cualquier consulta, no dude en contactarse con <a href="mailto:lpini@bigg.fit" style="color:#adff19;text-decoration:none;font-weight:600;">lpini@bigg.fit</a> o <a href="mailto:mbergara@bigg.fit" style="color:#adff19;text-decoration:none;font-weight:600;">mbergara@bigg.fit</a>.</div>' +
