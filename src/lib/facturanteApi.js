 ...
 */
export async function emitirComprobante({ franchisor, franchise, comp, referenciaIdComprobante, referenciaInvoice }) {
  const res = await fetch(BASE, {
    method:  'POST',
    headers: { 'Content-Type': 'application/json' },
    body:    JSON.stringify({ action: 'emitir', franchisor, franchise, comp, referenciaIdComprobante, referenciaInvoice }),
  });
